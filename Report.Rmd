...
`BMI`, linear predictor increases by `r round(fit.f$coefficients[[3]],3)`x$\log(1.1)$=`r round(fit.f$coefficients[[3]] * log(1.1), 3)`. Inverse of logit
function has to be applied on the linear predictor to
reveal the increase in shadow (dependent) variable.
