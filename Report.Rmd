...
World Health Organization Criteria^[World Health Organization, Report of a Study Group:
...
there is merit in using standard statistical models since sample size is
fairly large (768 observations) and underlying functional correlations
among variables can be evaluated. 
...
Our null hypothesis is that binary choice models will produce as 
good a result as ADAP.

*H0: Crossover point for sensitivity and specificity for binary choice models is greater than 0.76.*

# Data

Data comes from [Kaggle via UCI Machine Learning Repository](https://raw.githubusercontent.com/jbrownlee/Datasets/master/pima-indians-diabetes.data.csv).

which contains data on female patients at least 21 years old of Pima Indian heritage (update: download from here).
